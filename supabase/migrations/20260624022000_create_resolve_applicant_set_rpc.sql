-- Resolve the active question set assigned to an applicant.
-- Priority: explicit user assignment, then department, then organization.
...
BEGIN
  ...
  INTO v_department_id, v_organization_id
